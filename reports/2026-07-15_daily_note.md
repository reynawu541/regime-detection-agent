# Daily market regime research note — 2026-07-15
...
regime 0 (calm): ann. return 23.0%, ann. vol 10.0%, Sharpe 2.29, max drawdown -10.0%, 35% of days; regime 1 (moderate): ann. return 14.4%, ann. vol 12.1%, Sharpe 1.19, max drawdown -9.8%, 33% of days; regime 2 (elevated): ann. return 1.7%, ann. vol 20.9%, Sharpe 0.08, max drawdown -28.7%, 23% of days; regime 3 (crisis-like): ann. return 29.1%, ann. vol 35.5%, Sharpe 0.82, max drawdown -32.3%, 8% of days

## Regime statistics

|   regime |   n_days | share_of_days   | ann_return   | ann_vol   |   sharpe | max_drawdown   |   skew |   kurtosis |   n_episodes |   avg_episode_days |
|---------:|---------:|:----------------|:-------------|:----------|---------:|:---------------|-------:|-----------:|-------------:|-------------------:|
|        0 |     1421 | 35.3%           | 23.0%        | 10.0%     |     2.29 | -10.0%         |  -0.48 |       1.91 |           12 |           118.417  |
|        1 |     1349 | 33.5%           | 14.4%        | 12.1%     |     1.19 | -9.8%          |  -0.27 |       1.06 |           10 |           134.9    |
|        2 |      928 | 23.0%           | 1.7%         | 20.9%     |     0.08 | -28.7%         |  -0.28 |       1.31 |           14 |            66.2857 |
|        3 |      333 | 8.3%            | 29.1%        | 35.5%     |     0.82 | -32.3%         |  -0.21 |       5.31 |            6 |            55.5    |

![Benchmark price shaded by detected regime](2026-07-15_regime_timeline.png)
...
*Generated automatically by the regime-detection-agent pipeline on 2026-07-15 22:54 UTC. Universe: SPY + XLY, XLP, XLE, XLF, XLV, XLI, XLB, XLK, XLU. This note is end-of-day, backward-looking, and not investment advice.*