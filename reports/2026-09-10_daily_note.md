# Daily market regime research note — 2026-09-10

**Current regime: 0 (calm) -- annualized vol 10.0%, Sharpe 2.26, historically 35% of trading days.**
...
regime 0 (calm): ann. return 22.6%, ann. vol 10.0%, Sharpe 2.26, max drawdown -10.0%, 35% of days; regime 1 (moderate): ann. return 14.4%, ann. vol 12.1%, Sharpe 1.19, max drawdown -9.8%, 33% of days; regime 2 (elevated): ann. return 1.3%, ann. vol 20.6%, Sharpe 0.06, max drawdown -28.7%, 23% of days; regime 3 (crisis-like): ann. return 31.4%, ann. vol 35.5%, Sharpe 0.88, max drawdown -29.5%, 8% of days

## Regime statistics

|   regime |   n_days | share_of_days   | ann_return   | ann_vol   |   sharpe | max_drawdown   |   skew |   kurtosis |   n_episodes |   avg_episode_days |
|---------:|---------:|:----------------|:-------------|:----------|---------:|:---------------|-------:|-----------:|-------------:|-------------------:|
|        0 |     1430 | 35.1%           | 22.6%        | 10.0%     |     2.26 | -10.0%         |  -0.47 |       1.89 |           13 |           110      |
...
![Benchmark price shaded by detected regime](2026-09-10_regime_timeline.png)
...
Regime separation by mean return is not statistically significant (ANOVA p=0.18); regimes here primarily separate volatility, correlation-breakdown and liquidity behavior, not average forward returns. Cross-method label agreement: HMM vs GMM 47%, HMM vs KMeans 85%.
...
*Generated automatically by the regime-detection-agent pipeline on 2026-09-10 23:38 UTC. Universe: SPY + XLY, XLP, XLE, XLF, XLV, XLI, XLB, XLK, XLU. This note is end-of-day, backward-looking, and not investment advice.*