# Daily market regime research note — 2026-09-23
...
|---------:|---------:|:----------------|:-------------|:----------|---------:|:---------------|-------:|-----------:|-------------:|-------------------:|
|        0 |     1549 | 38.0%           | 22.9%        | 9.7%      |     2.36 | -7.6%          |  -0.31 |       1.44 |           17 |            91.1176 |
|        1 |     1004 | 24.6%           | 14.0%        | 11.8%     |     1.18 | -9.7%          |  -0.3  |       0.98 |            4 |           251      |
|        2 |     1193 | 29.3%           | 3.4%         | 19.7%     |     0.17 | -32.9%         |  -0.33 |       1.44 |           21 |            56.8095 |
|        3 |      332 | 8.1%            | 31.8%        | 35.7%     |     0.89 | -28.3%         |  -0.2  |       5.14 |            6 |            55.3333 |

![Benchmark price shaded by detected regime](2026-09-23_regime_timeline.png)
...
Regime separation by mean return is not statistically significant (ANOVA p=0.19); regimes here primarily separate volatility, correlation-breakdown and liquidity behavior, not average forward returns. Cross-method label agreement: HMM vs GMM 19%, HMM vs KMeans 84%.
...
*Generated automatically by the regime-detection-agent pipeline on 2026-09-24 00:11 UTC. Universe: SPY + XLY, XLP, XLE, XLF, XLV, XLI, XLB, XLK, XLU. This note is end-of-day, backward-looking, and not investment advice.*