# Daily market regime research note — 2026-08-11

**Current regime: 2 (elevated) -- annualized vol 21.9%, Sharpe 0.14, historically 25% of trading days.**
...
regime 0 (calm): ann. return 22.8%, ann. vol 10.0%, Sharpe 2.28, max drawdown -10.0%, 35% of days; regime 1 (moderate): ann. return 14.3%, ann. vol 12.2%, Sharpe 1.17, max drawdown -9.7%, 33% of days; regime 2 (elevated): ann. return 3.0%, ann. vol 21.9%, Sharpe 0.14, max drawdown -27.4%, 25% of days; regime 3 (crisis-like): ann. return 31.6%, ann. vol 34.3%, Sharpe 0.92, max drawdown -25.0%, 7% of days
...
|        2 |      994 | 24.5%           | 3.0%         | 21.9%     |     0.14 | -27.4%         |   0.14 |       4.13 |           14 |             71     |
|        3 |      299 | 7.4%            | 31.6%        | 34.3%     |     0.92 | -25.0%         |  -0.57 |       5.54 |            4 |             74.75  |

![Benchmark price shaded by detected regime](2026-08-11_regime_timeline.png)
...
Regime separation by mean return is not statistically significant (ANOVA p=0.23); regimes here primarily separate volatility, correlation-breakdown and liquidity behavior, not average forward returns. Cross-method label agreement: HMM vs GMM 97%, HMM vs KMeans 87%.
...
*Generated automatically by the regime-detection-agent pipeline on 2026-08-11 22:35 UTC. Universe: SPY + XLY, XLP, XLE, XLF, XLV, XLI, XLB, XLK, XLU. This note is end-of-day, backward-looking, and not investment advice.*