...
**Current regime: 2 (elevated) -- annualized vol 22.3%, Sharpe 0.07, historically 23% of trading days.**
...
regime 0 (calm): ann. return 22.6%, ann. vol 10.1%, Sharpe 2.23, max drawdown -10.0%, 36% of days; regime 1 (moderate): ann. return 14.3%, ann. vol 12.2%, Sharpe 1.17, max drawdown -9.7%, 33% of days; regime 2 (elevated): ann. return 1.6%, ann. vol 22.3%, Sharpe 0.07, max drawdown -27.4%, 23% of days; regime 3 (crisis-like): ann. return 31.6%, ann. vol 34.4%, Sharpe 0.92, max drawdown -25.0%, 7% of days
...
|        2 |      938 | 23.3%           | 1.6%         | 22.3%     |     0.07 | -27.4%         |   0.16 |       4    |           15 |            62.5333 |
...
Regime separation by mean return is not statistically significant (ANOVA p=0.21); regimes here primarily separate volatility, correlation-breakdown and liquidity behavior, not average forward returns. Cross-method label agreement: HMM vs GMM 97%, HMM vs KMeans 88%.
...
*Generated automatically by the regime-detection-agent pipeline on 2026-06-26 16:33 UTC. Universe: SPY + XLY, XLP, XLE, XLF, XLV, XLI, XLB, XLK, XLU. This note is end-of-day, backward-looking, and not investment advice.*