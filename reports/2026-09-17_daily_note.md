# Daily market regime research note — 2026-09-17
...
|---------:|---------:|:----------------|:-------------|:----------|---------:|:---------------|-------:|-----------:|-------------:|-------------------:|
|        0 |     1547 | 38.0%           | 22.7%        | 9.7%      |     2.34 | -7.6%          |  -0.32 |       1.45 |           17 |            91      |
...
![Benchmark price shaded by detected regime](2026-09-17_regime_timeline.png)
...
Regime separation by mean return is not statistically significant (ANOVA p=0.19); regimes here primarily separate volatility, correlation-breakdown and liquidity behavior, not average forward returns. Cross-method label agreement: HMM vs GMM 86%, HMM vs KMeans 84%.
...
*Generated automatically by the regime-detection-agent pipeline on 2026-09-17 23:51 UTC. Universe: SPY + XLY, XLP, XLE, XLF, XLV, XLI, XLB, XLK, XLU. This note is end-of-day, backward-looking, and not investment advice.*