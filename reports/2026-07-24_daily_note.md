# Daily market regime research note — 2026-07-24
...
|        2 |      981 | 24.3%           | 1.8%         | 22.0%     |     0.08 | -27.4%         |   0.15 |       4.12 |           14 |            70.0714 |
|        3 |      299 | 7.4%            | 31.6%        | 34.3%     |     0.92 | -25.0%         |  -0.57 |       5.54 |            4 |            74.75   |

![Benchmark price shaded by detected regime](2026-07-24_regime_timeline.png)
...
Regime separation by mean return is not statistically significant (ANOVA p=0.19); regimes here primarily separate volatility, correlation-breakdown and liquidity behavior, not average forward returns. Cross-method label agreement: HMM vs GMM 96%, HMM vs KMeans 87%.
...
*Generated automatically by the regime-detection-agent pipeline on 2026-07-24 22:57 UTC. Universe: SPY + XLY, XLP, XLE, XLF, XLV, XLI, XLB, XLK, XLU. This note is end-of-day, backward-looking, and not investment advice.*